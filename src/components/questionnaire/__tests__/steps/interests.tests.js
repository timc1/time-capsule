...
describe('Questionnaire -- Interests', () => {
  ...
  test('Should render at first showing initial hobbies checkboxes and a disabled next button.', async () => {
  ...
  test(`Modal window should show when user clicks 'more', and close when user click exit button.`, async () => {
